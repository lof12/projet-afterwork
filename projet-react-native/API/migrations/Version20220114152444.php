 ...
 */
final class Version20220114152444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE id_employe id_employe INT DEFAULT NULL, CHANGE id_rubrique id_rubrique INT DEFAULT NULL');
        $this->addSql('ALTER TABLE categorie CHANGE import import TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE client CHANGE abonnement_newsletter abonnement_newsletter TINYINT(1) NOT NULL, CHANGE id_role id_role INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_C7440455DC499668 ON client (id_role)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE id_rubrique id_rubrique INT NOT NULL, CHANGE id_employe id_employe INT NOT NULL');
        $this->addSql('ALTER TABLE categorie CHANGE import import TINYINT(1) DEFAULT \'0\'');
        $this->addSql('ALTER TABLE client DROP FOREIGN KEY FK_C7440455DC499668');
        $this->addSql('ALTER TABLE client DROP FOREIGN KEY FK_C7440455DC499668');
        $this->addSql('ALTER TABLE client CHANGE id_role id_role INT NOT NULL, CHANGE abonnement_newsletter abonnement_newsletter BINARY(1) NOT NULL');
        $this->addSql('DROP INDEX idx_c7440455dc499668 ON client');
